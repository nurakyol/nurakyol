...
Yazılım dünyasında kendini sürekli geliştiren bir öğrenciyim. Akademik projelerimi ve kişisel çalışmalarımı burada paylaşıyorum.

* 🔭 Şu sıralar **C#** ile masaüstü uygulamaları geliştiriyor ve **HTML/CSS** ile interaktif web tasarımları yapıyorum.
